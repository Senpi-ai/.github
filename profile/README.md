...
| **The Harness** | The disciplined execution layer around the model: skills-first routing, ~125 MCP tools, and a runtime supervisor that owns sizing, risk gates, and two-phase stop-loss exits. |
...
| **Strategy templates** | 80+ deployable trading strategies, each a market thesis on its own funded wallet. **Open source.** |
